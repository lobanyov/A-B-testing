...
var supportIconsLinks = [
  'https://www.se.com/uk/en/work/support/',
  'https://www.se.com/uk/en/work/support/customer-care/contact-schneider-electric.jsp',
  'https://www.se.com/uk/en/locator/distributor',
  'https://www.se.com/uk/en/faqs/home/',
  'https://www.se.com/uk/en/work/support/customer-care/contact-sales.jsp',
];
...
function init() {
  var categoryHeader = document.querySelector('.category-page__header');
  ...
  supportBlock.style.cssText = 'display: flex; background: #fff; width: 100%;' +
    ' margin-top: 25px; outline: 1px solid #e7e6e6';
  ...
  document.querySelector('.se-col.UXD-508')
    .insertAdjacentElement('afterbegin', mobileSupportBlock);
  categoryHeader.insertAdjacentElement('beforeend', supportBlock);
